...
def update():
   try:
     ...
     beds1 = beds.get()
     price1= price.get()
     cursor.execute("update room_list set room_type='"+rtype1+"',Floor='"+floor1+"',No_of_beds="+str(beds1)+",Overnight_Price="+str(price1)+" where Room_No="+str(rno1))
