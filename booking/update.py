...
def update():
   try:
     ...
     cursor = conn.cursor()
     cursor.execute("update guest_list set Guest_Name='"+name.get()+"', Guest_ID='"+str(gid.get())+"', Occupancy='"+str(occ.get())+"', Booking_date='"+bdate.get()+"', Check_in_date='"+idate.get()+"',check_out_date='"+odate.get()+"' where Room_No="+str(rno.get()))
